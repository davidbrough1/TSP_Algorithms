# This file conatins code used to plot sqd.e
...
for i in range(len(onlyfiles)):
    ...
    input_file_reader = csv.reader(
        open(mypath + "/" + onlyfiles[i]), delimiter=',')
    counter = 0
    row_error = []
    row_time = []
...
output_file = open(output_path + "/" + "results" + "_" +
                   name + str(quality) + str(optimum) + "sqd.txt", 'w')
